        ...
        <div className="max-w-[1340px] mx-auto px-[50px]">
          <div className="flex gap-16 items-start">
            ...
            <div className="flex-shrink-0">
              <img
                className="w-[557px] h-[890px] rounded-[0px_0px_300px_300px] object-cover"
                alt="Student"
                src="https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-2-image-1.png"
              />
            </div>
            ...
            <div className="flex-1 pt-8">
              ...
              <div className="[-webkit-text-stroke:3px_#ef7f1a] [font-family:'Inter',Helvetica] font-bold text-transparent text-9xl mb-8">
                Overview
              </div>
              ...
              <div className="relative mb-8">
                <img
                  className="w-[707px] h-36"
                  alt="Vector"
                  src="https://c.animaapp.com/mjmwrwbp4K97wU/img/vector-2.svg"
                />
                <p className="absolute top-6 left-8 [font-family:'Inter',Helvetica] font-bold text-white text-2xl">
                  Students from Grades 9-12 work with<br />
                  "active industry professionals" on simulated<br />
              ...
              <div className="space-y-6 mb-10">
                {features.map((item, index) => (
                  <div key={index} className="flex items-center gap-4">
                    <img className="w-[73px] h-[73px] object-cover" alt="Icon" src={item.icon} />
                    <p className="[font-family:'Inter',Helvetica] font-bold text-[#3d3d3d] text-2xl">
                      {item.text}
                    </p>
                  </div>
                ))}
              ...
              {/* Apply Now */}
              <a href="#contact-form" className="bg-[#ef7f1a] w-[291px] h-[86px] rounded-[50px] flex items-center justify-center hover:bg-[#d66f15] active:bg-[#c06312] transition-all duration-200">
